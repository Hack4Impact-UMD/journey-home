    ...
    return (
        <div className="space-y-6">
                ...
                <p className="text-sm text-gray-600 bg-amber-50 border border-amber-200 rounded-md px-6 py-3 max-w-2xl mx-auto">
                    All items are gently used. We are unable to provide new items. We will do our best to provide as many of the requested items as possible based on our inventory, however we may not be able to provide every item a client requests.
                </p>

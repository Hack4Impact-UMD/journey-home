...
export default function Step1ClientInfo() {
    ...
    const validateForm = () => {
        ...
        if (client.questions.moveInDate === undefined)
            newErrors.hasMovedIn = "Please select move-in date";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2 space-y-6">
                        <FormInput
                            label="HMIS Number"
                            required
                            value={formState.clientInfoAndNewHome.hmis}
                            onChange={(e) =>
                        ...
                        <FormInput
                            ...
                            required
                            type="tel"
                            value={formState.clientInfoAndNewHome.phoneNumber}
                            onChange={(e) => {
                                ...
                                const formatted = value
                                    ...
                                    .slice(0, 12);
                                updateClientInfo({ phoneNumber: formatted });
                            }}
                        />
                        {errors.phoneNumber && (
                            <p className="text-red-500 text-sm">
                        ...
                        <FormInput
                            ...
                            type="tel"
                            value={
                                formState.clientInfoAndNewHome.secondaryContact
                                    ?.phone || ""
                            }
                            onChange={(e) => {
                                const value = e.target.value.replace(/\D/g, "");
                        ...
                        <FormInput
                            ...
                            onChange={(e) =>
                                updateClientQuestions({
                                    childrenInFamily: Number(e.target.value),
                                })
                            }
                        />
                        ...
                        type="date"
                        value={
                            formState.clientInfoAndNewHome.questions.moveInDate
                            ? new Date(
                                (formState.clientInfoAndNewHome.questions.moveInDate as Timestamp).toMillis()
                        ...
                        onChange={(e) => {
                            ...
                            updateClientQuestions({
                                moveInDate: Timestamp.fromDate(newDate),
                            });
                            } else {
                            updateClientQuestions({
                        ...
                        <FormInput
                            ...
                            value={
                                formState.clientInfoAndNewHome.questions.notes
                            }
                            onChange={(e) =>
                                updateClientQuestions({ notes: e.target.value })
                            }
                        />
                        ...
                        <FormInput
                            ...
                            value={formState.clientInfoAndNewHome.address.apt}
                            onChange={(e) =>
                                updateClientInfo({
                                    address: {
                                        ...formState.clientInfoAndNewHome

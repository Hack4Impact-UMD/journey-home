    ...
    return (
        <div>
            ...
            <div className="bg-white rounded-none p-6">
                <div className="mb-4">
                    <DropdownMenu>
                        <DropdownMenuTrigger className="flex items-center gap-2 border border-gray-300 rounded-md px-3 py-1.5 text-sm text-[#3D4B6B] bg-white hover:bg-gray-50 transition-colors">
                        ...
                        <DropdownMenuContent className="w-52">
                            {SHIFT_OPTIONS.map((option) => (
                                <DropdownMenuItem
                                    ...
                                    className={filterType === option ? "text-[#02AFC7] font-semibold bg-cyan-50" : "text-[#3D4B6B]"}
                                >
                                    {option}
                                </DropdownMenuItem>
                            ))}

                ...
                <div className="flex flex-1 min-h-0 max-md:flex-col">
                    ...
                    <div className="flex-1 min-h-0 bg-[#F7F7F7] pt-8 max-md:pt-1 pb-4 px-6 flex flex-col max-md:bg-transparent max-md:p-0">
                        ...
                        <div className="flex gap-8 text-sm">
                            ...
                            <Link
                                className={`py-4 font-family-roboto text-sm${pathname.startsWith("/control-panel/waiver") ? " border-b-2 border-primary text-primary" : ""}`}
                                href="/control-panel/waiver"
                                aria-current={pathname.startsWith("/control-panel/waiver") ? "page" : undefined}
                            >
                                Waiver
                            </Link>
                        </div>

        ...
        <div className="space-y-6">
            ...
            <div className="mb-6">
                ...
                <div className="space-y-4 text-sm text-gray-700">
                    <div>
                        <p className="mb-2">
                            Items that we accept and{" "}
                            <span className="font-normal">
                                need this form to be filled out
                            </span>{" "}
                            for can be viewed in the category dropdown below.
                            Items that we accept but{" "}
                            <span className="font-bold">
                                do not need the form for
                            </span>{" "}
                            are listed below. These items can be dropped off at
                            our warehouse or picked up with other larger items.
                            Please contact volunteer@journeyhomect.org for any
                            questions.
                        </p>
                    ...
                    <div className="mt-6">
                        <p className="mb-2">
                            We do <span className="font-extrabold">not</span>{" "}
                        ...
                        <ul className="list-disc ml-6 space-y-1">
                            ...
                            <li>
                                Stained/ripped sofas, mattresses, armchairs (or
                                anything not gently used)
                            </li>
